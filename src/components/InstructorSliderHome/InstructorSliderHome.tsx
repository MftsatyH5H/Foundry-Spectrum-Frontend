...
const InstructorSliderHome = () => {
    return ( 
        <div className='flex flex-row gap-[48px] items-center mt-16'>
            <div className='bg-opacity-[6%] p-[48px] flex flex-col items-center gap-[16px] border border-[#2F2F4F] backdrop-blur-[12px] rounded-[8px] group groupInstructor transition-all duration-3000 ease-in-out'>
                <img src="/profile.png" alt="" className='rounded-full w-[96px] border-[2px] border-solid border-[#2F2F4F] group groupInstructor-hover:border-foundryyellow transition-colors duration-3000' />
