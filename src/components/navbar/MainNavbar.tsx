...
const MainNavbar: React.FC = () => {
    ...
    return (
        <React.Fragment>
            {/* Navbar */}
            <nav className={`flex justify-between fixed items-center h-[72px] w-full backdrop-blur-sm border-b border-transparent px-[48px] transition-all duration-300 ease-in-out z-[1000] top-0 ${
                isMenuOpen 
