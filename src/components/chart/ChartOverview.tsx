...
function ChartOverview() {
  return (
    <div className='flex flex-row justify-between items-center rounded-sm'>
        <div className='bg-[#140d21] w-1/2 px-32 py-[2.3rem]'>
            <div className='flex justify-between items-center'>
                <div className='flex flex-col items-center justify-between'>
                    <span className='text-foundryyellow font-bold text-2xl font-[Agrandir]'>12</span>
                    <span className='text-white font-poppins font-light'>Learning Hours</span>
                </div>
                <div className='flex flex-col items-center content-center'>
                    <span className='text-foundryyellow font-bold text-2xl font-[Agrandir]'>32</span>
                    <span className='text-white font-poppins font-light'>Answered Questions</span>
                </div>
            </div>
